use crate::core::{Column, MySqlDataType, RelationshipOps, RelationshipType, TableNode, TableOps};
...
fn test_delete_table_with_relationships() {
    ...
    let rel =
        crate::core::Relationship::new("user_posts", RelationshipType::OneToMany, "id", "user_id");
    graph
