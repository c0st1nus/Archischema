...
- [x] 5.7. Мигрировать диалог создания колонки (ColumnEditor остался inline компонентом)
- [x] 5.8. Мигрировать другие диалоги создания (NewTableDialog мигрирован)
...
- Мигрирован `NewTableDialog` на использование HTML `<dialog>`
